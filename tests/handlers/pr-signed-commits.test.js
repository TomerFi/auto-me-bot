  ...
  suite("Test handler running", () => {
    ...
    [
      ...
      },
      {
        ...
        stubCommitsList: {
          status: 200,
          data: [commitSignedByAuthor, commitSignedByAuthor],
        },
      },
    ].forEach((testCase) => {
      test(`${testCase.testTitle}, expect a successful check run`, async () => {
        ...
        verifyEmailStub
          ...
          .yields(null, {
            code: emailVerifier.verifyCodes.finishedVerification,
          });
    ...
    [
      {
        testTitle:
          "Test with one commit signed by someone else (not author/committer)",
